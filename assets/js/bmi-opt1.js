...
if ($('bmi').textContent < 18.5) {
	you = 'You are below the recommended weight for your height and should not be attempting to lose weight. A healthy BMI range is between 18.5-25. We recommend that you consult your GP.</p><p class="bold">A healthy BMI range is between 18.5-25</p>';
	...
	you = 'You are within the overweight range and your health will benefit if you lost a little weight. You certaintly don\'t want to put on any weight. Look at the BMI chart to see your ideal weight range for your height.<p class="bold">A healthy BMI range is between 18.5-25</p>';
} else {
